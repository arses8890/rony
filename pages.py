...
<head>
<meta charset="UTF-8"><meta name="viewport" content="width=device-width, initial-scale=1.0">
<title>Arses VPN Panel · RVG + Spider</title>
<link rel="preconnect" href="https://fonts.googleapis.com">
...
/* ===== Arses Cyberpunk UI ===== */
:root{--accent:#6d3cff;--accent2:#4da3ff;--purple:#d946ef;--card:#07142c;--bg:#020615;--bg2:#030a1d;--bg3:#0b1740;--card-b:rgba(66,110,255,.28);--card-bh:rgba(217,70,239,.65);--t1:#f4f7ff;--t2:#a9b7df;--t3:#6573a6}
body{background:radial-gradient(circle at 70% 0%,rgba(74,35,180,.16),transparent 34%),linear-gradient(135deg,#01030c,#04091d 45%,#08031a);background-attachment:fixed}
.sidebar{background:linear-gradient(180deg,rgba(2,6,20,.98),rgba(5,7,27,.98));border-left:1px solid rgba(80,111,255,.45);box-shadow:0 0 45px rgba(37,61,255,.12)}
.logo{padding:18px 15px;border-bottom:1px solid rgba(85,103,255,.22)}
.logo-img{border:none;box-shadow:0 0 22px rgba(109,60,255,.55);background:transparent}
.logo-name{font-size:17px;font-weight:900;background:linear-gradient(90deg,#fff,#9eb7ff 45%,#e879f9);-webkit-background-clip:text;color:transparent}
.logo-sub{color:#8f9fd0}
.nav-it{border-radius:11px;margin:3px 7px;border-right:0!important;position:relative}
.nav-it.on,.nav-it:hover{background:linear-gradient(90deg,rgba(53,88,255,.22),rgba(167,49,255,.28));box-shadow:inset 0 0 20px rgba(91,67,255,.1),0 0 16px rgba(75,72,255,.08);color:#fff}
.nav-it.on:before{content:'';position:absolute;right:0;top:6px;bottom:6px;width:3px;border-radius:3px;background:linear-gradient(#45a3ff,#c026ff);box-shadow:0 0 10px #7c3aed}
.main{padding:18px 22px 50px}
.topbar{margin-bottom:14px}.tb-title{font-size:20px}.tb-title i{color:#8b5cf6;text-shadow:0 0 12px #8b5cf6}
.metrics{gap:12px}.metric{border-radius:15px;background:linear-gradient(145deg,rgba(8,25,57,.92),rgba(15,7,45,.94));border:1px solid rgba(65,101,255,.48);box-shadow:inset 0 0 24px rgba(66,70,255,.08),0 10px 30px rgba(0,0,0,.2)}
.metric:hover{box-shadow:0 0 25px rgba(94,61,255,.28);border-color:#8b5cf6}.m-icon{background:linear-gradient(135deg,#1b62ff,#8b2cff)!important;box-shadow:0 0 20px rgba(80,72,255,.45);border:1px solid rgba(255,255,255,.15)}
.arses-hero{min-height:235px;margin-bottom:15px;border:1px solid rgba(75,104,255,.65);border-radius:18px;overflow:hidden;position:relative;background:linear-gradient(90deg,rgba(3,8,25,.96) 0%,rgba(8,7,30,.82) 42%,rgba(8,4,30,.28) 100%),url('/arses-hero.jpg') center/cover;box-shadow:0 0 35px rgba(72,45,255,.18),inset 0 0 60px rgba(139,92,246,.1)}
.arses-hero:after{content:'';position:absolute;inset:0;background:linear-gradient(0deg,rgba(4,2,20,.78),transparent 48%);pointer-events:none}.arses-hero-copy{position:relative;z-index:2;padding:34px 38px;max-width:560px}.arses-kicker{font-size:17px;font-weight:800;color:#a78bfa;letter-spacing:.08em}.arses-hero-title{font-size:31px;font-weight:900;margin-top:6px;background:linear-gradient(90deg,#fff,#b8c7ff,#f0abff);-webkit-background-clip:text;color:transparent}.arses-hero-sub{font-size:13px;color:#b7c1e8;margin-top:8px}.arses-hero-actions{display:flex;gap:8px;margin-top:18px;flex-wrap:wrap}.arses-hero-art{position:absolute;inset:0;pointer-events:none}.arses-glow{position:absolute;right:16%;top:15%;width:240px;height:180px;border-radius:50%;background:radial-gradient(circle,rgba(154,70,255,.38),transparent 68%);filter:blur(8px)}
.arses-quick-grid{display:grid;grid-template-columns:repeat(4,1fr);gap:12px;margin-bottom:15px}.arses-quick-grid button{font-family:inherit;color:#fff;background:linear-gradient(145deg,rgba(8,20,48,.96),rgba(26,5,52,.92));border:1px solid rgba(75,102,255,.55);border-radius:15px;padding:13px 12px;cursor:pointer;text-align:right;display:flex;align-items:center;gap:11px;transition:.2s}.arses-quick-grid button:hover{transform:translateY(-2px);border-color:#d946ef;box-shadow:0 0 24px rgba(217,70,239,.18)}.arses-quick-grid i{width:40px;height:40px;border-radius:50%;display:flex;align-items:center;justify-content:center;background:linear-gradient(135deg,#1664ff,#a82cff);font-size:19px;box-shadow:0 0 18px rgba(97,60,255,.45)}.arses-quick-grid span{font-weight:800;font-size:12px}.arses-quick-grid small{display:block;color:#7280ae;font-size:9px;margin-top:2px}.arses-dash-grid{display:grid;grid-template-columns:1.35fr 1fr;gap:13px;margin-bottom:15px}.arses-activity-card,.arses-status-card{background:linear-gradient(145deg,rgba(5,16,38,.96),rgba(17,5,40,.94));border:1px solid rgba(75,102,255,.42)}.arses-activity-item{display:flex;align-items:center;gap:9px;padding:9px 0;border-bottom:1px solid rgba(77,96,165,.18)}.arses-activity-item:last-child{border-bottom:0}.arses-activity-dot{width:8px;height:8px;border-radius:50%;background:#00e89a;box-shadow:0 0 9px #00e89a;flex:0 0 auto}.arses-activity-text{font-size:11px;color:#c6d0ee;flex:1}.arses-activity-time{font-size:9px;color:#6875a5}.arses-status-row{display:flex;align-items:center;justify-content:space-between;padding:11px 0;border-bottom:1px solid rgba(77,96,165,.18);font-size:11px}.arses-status-row:last-child{border-bottom:0}.online-pill{color:#26e6a0;font-size:10px}.arses-mini-brand{padding:10px;border:1px solid rgba(109,60,255,.3);border-radius:11px;background:rgba(82,43,180,.09);text-align:center;margin-bottom:7px}.arses-mini-brand b{display:block;font-size:16px}.arses-mini-brand span{font-size:9px;color:#6978a8}.tg-btn{display:none!important}.dash-footer{border-top:1px solid rgba(72,92,160,.2)}
[data-theme="light"] body{background:#f0f2fb}.arses-hero{min-height:210px}
@media(max-width:900px){.arses-quick-grid{grid-template-columns:1fr 1fr}.arses-dash-grid{grid-template-columns:1fr}.arses-hero-title{font-size:25px}}
@media(max-width:640px){.main{padding:64px 12px 30px}.arses-hero{min-height:250px}.arses-hero-copy{padding:24px 20px}.arses-hero-title{font-size:22px}.arses-quick-grid{grid-template-columns:1fr 1fr}.metrics{grid-template-columns:1fr 1fr}}
</style>
</head>
<body>
...
<div class="mob-top">
  <div class="ml">
    ...
    <span class="mob-title">Arses VPN Panel</span>
  </div>
  <div class="mob-right">
...
<aside class="sidebar" id="sb">
  ...
  <div class="logo">
    <div class="logo-img"><img src="/arses-logo.svg" alt="Arses"></div>
    <div><div class="logo-name">Arses</div><div class="logo-sub">VPN Panel · RVG + Spider</div></div>
  </div>
  <div class="nav-wrap">
    <div class="nav-sec">Arses Panel</div>
    ...
    <div class="nav-it" data-pg="subgroups"><i class="ti ti-folders"></i> گروه‌های اشتراک <span class="nav-badge" id="subs-nb">0</span></div>
    ...
    <div class="nav-it" data-pg="nodes"><i class="ti ti-topology-star-3"></i> سرورها و نودها <span class="nav-badge" id="nodes-nb">0</span></div>
    <div class="nav-sec">مدیریت سیستم</div>
  ...
  <div class="sb-foot">
    ...
    <div class="arses-mini-brand"><b>Arses</b><span>اتصال امن، آزاد و سریع</span></div>
...
<section class="pg on" id="pg-overview">
  ...
  <div class="arses-hero">
    <div class="arses-hero-copy">
      <div class="arses-kicker">Arses VPN Panel</div>
      <div class="arses-hero-title">اتصال امن، آزاد و سریع</div>
      <div class="arses-hero-sub">نسخه ترکیبی RVG + Spider با مدیریت کامل کانفیگ‌ها</div>
      <div class="arses-hero-actions">
        <button class="btn btn-p" onclick="openModal('modal-create-link')"><i class="ti ti-square-rounded-plus"></i> ساخت کانفیگ جدید</button>
        <button class="btn btn-g" onclick="navTo('links')"><i class="ti ti-link"></i> مدیریت کانفیگ‌ها</button>
      </div>
    </div>
    <div class="arses-hero-art"><div class="arses-glow"></div></div>
  </div>
  <div class="metrics">
  ...
  <div class="arses-quick-grid">
    <button onclick="openModal('modal-create-link')"><i class="ti ti-plus"></i><span>ساخت کانفیگ</span><small>VLESS / WS</small></button>
    <button onclick="navTo('links')"><i class="ti ti-users"></i><span>مدیریت کاربران</span><small>کانفیگ‌های فعال</small></button>
    <button onclick="navTo('connections')"><i class="ti ti-plug-connected"></i><span>اتصالات آنلاین</span><small>وضعیت لحظه‌ای</small></button>
    <button onclick="navTo('logs')"><i class="ti ti-file-text"></i><span>گزارش‌ها</span><small>لاگ فعالیت</small></button>
  </div>
  <div class="arses-dash-grid">
    <div class="card arses-activity-card"><div class="card-title"><i class="ti ti-activity"></i> آخرین فعالیت‌ها</div><div id="dash-activity">در حال بارگذاری...</div></div>
    <div class="card arses-status-card"><div class="card-title"><i class="ti ti-shield-check"></i> وضعیت سرویس</div><div class="arses-status-row"><span>پنل Arses</span><b class="online-pill">● آنلاین</b></div><div class="arses-status-row"><span>API</span><b class="online-pill">● فعال</b></div><div class="arses-status-row"><span>پروتکل‌های RVG</span><b class="online-pill">● آماده</b></div><div class="arses-status-row"><span>اشتراک‌ها</span><b class="online-pill">● فعال</b></div></div>
  </div>
  ...
  <div class="dash-footer">
    <span class="df-text">Arses VPN Panel · RVG + Spider</span>
    <span class="df-link">Arses · نسخه ترکیبی RVG + Spider</span>
  </div>
</section>
...
async function loadActivity(){
  try{
    ...
    if(da){ const short=logs.slice(0,5); da.innerHTML=short.length?short.map(l=>`<div class="arses-activity-item"><span class="arses-activity-dot"></span><span class="arses-activity-text">${esc(l.message)}</span><span class="arses-activity-time">${new Date(l.time).toLocaleTimeString('fa-IR',{hour:'2-digit',minute:'2-digit'})}</span></div>`).join(''):'<div class="empty">هنوز فعالیتی ثبت نشده</div>'; }
  }catch(e){console.error(e)}
}
